      ...
      <div className="p-4 w-2/5 mx-auto ">
        <form id="eventForm" onSubmit={handleSubmit} className=" mx-auto px-4">
            ...
            <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
              <div className="text-center">
                ...
                <div className="mt-4 flex text-sm leading-6 text-gray-600">
                  <label
                    htmlFor="file-upload"
                    className="relative cursor-pointer rounded-md bg-white font-semibold text-[#ba90db] focus-within:outline-none focus-within:ring-2 focus-within:ring-[#B684DD] focus-within:ring-offset-2 hover:text-[#B684DD]"
                  >
          ...
          <div className="col-span-full flex justify-center items-center mt-5">
            {loading ? (
              <HashLoader color="#B684DD" size={50} />
            ) : (
              <button
                type="submit"
