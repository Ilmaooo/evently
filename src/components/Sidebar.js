  ...
  return (
    <>
      ...
      <div
        ...
        } h-screen w-full flex-col items-center rounded-tr-[40px] 
        bg-gradient-to-tl from-mobileSidebarPurple to-mobileSidebarBlue 
        to-60% text-[#BB90DB] sm:flex sm:w-60 sm:from-sidebarPurple sm:to-sidebarBlue`}
      >
